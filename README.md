...
i) агрегировать entity из всех kafka-сообщений и сохранить одновременно -- 
...
ii) сохранять entity из одного kafka-message одним запросом -- было бы хорошо, если бы не было требования обрабатывать
...
iii) сохранять каждый entity отдельно -- было бы слишком медленно
